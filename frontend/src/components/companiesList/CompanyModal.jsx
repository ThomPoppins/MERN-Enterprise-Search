  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="my-2">
          Future company description: Lorem ipsum dolor sit amet, consectetur
          adipiscing elit. Duis sed dolor felis. In ultricies, augue eget
          blandit rutrum, sem nisi maximus metus, ut auctor magna odio sed
          tellus. Cras ullamcorper tristique lacus, mattis lacinia velit
          eleifend nec. Sed est leo, vehicula sed velit et, imperdiet suscipit
          magna. Aenean ornare vitae elit vitae egestas. Quisque erat leo,
          lacinia at dolor et, porttitor auctor ipsum. Sed pulvinar, lacus at
          pulvinar bibendum, nulla massa luctus nisi, id dignissim magna sem
          eget felis. Vivamus a ex ante. Curabitur a mauris ut lectus dapibus
          pretium.
        </p>
      </div>
    </div>
